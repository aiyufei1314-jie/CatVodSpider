...
rd /s /q "%~dp0\spider.jar\smali\androidx\concurrent" 2>nul

if not exist "%~dp0\spider.jar\smali\com\github\catvod\" md "%~dp0\spider.jar\smali\com\github\catvod\"
if not exist "%~dp0\spider.jar\smali\androidx\" md "%~dp0\spider.jar\smali\androidx\"

move "%~dp0\APK_decode\smali\com\github\catvod\spider" "%~dp0\spider.jar\smali\com\github\catvod\"
move "%~dp0\APK_decode\smali\androidx\concurrent" "%~dp0\spider.jar\smali\androidx\"
